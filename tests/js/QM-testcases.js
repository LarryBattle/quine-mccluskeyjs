...
var runTests = function () {
    test("Testing qm.func.isArray()", function () {
		var func = qm.func.isArray;
        equal(func([1, 2, 3]),true);
        equal(func({"1" : 3}),false);
        equal(func("not array"), false);
        equal(func(1), false);
    });
    test("Testing qm.func.getObjProperties()", function () {
		var func = qm.func.getObjProperties;
        deepEqual(func({}), []);
        deepEqual(func({
                "1" : 1,
                "2" : 1,
    ...
    test("Testing qm.func.getCharIndexesFromSimStrs() wtih invalid input", function () {
    ...
    test("Testing qm.func.getObjFromStrSplit()", function () {
        ...
        deepEqual( func("0"), obj);
		obj = {
			0 : null
		};
        deepEqual(func("0", null, null), obj);
		obj = {
			3 : 1,
			2 : 1,
			1 : 1,
